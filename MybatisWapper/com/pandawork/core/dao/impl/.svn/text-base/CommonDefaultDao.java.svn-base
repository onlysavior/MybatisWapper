...
public class CommonDefaultDao extends AbstractBaseDao implements CommonDao {
    ...
    public <T> Serializable insertAndReturn(T obj) throws Exception{
    	...
    	return (Integer)getSqlSession().selectOne(getNameSpace() + "getLastestId", param);
    }
    ...
    public <T> void saveOrUpdate(T obj) throws Exception {
    	...
    	List<KeyValuePair> keyValuePairs = CommonDaoUtil.listKeyValuePair(obj,obj.getClass(),true);
    ...
    public <T, I extends Serializable> T queryById(Class<T> clazz, I id) throws Exception {
    	...
    	resultMap = (HashMap<String, Object>)getSqlSession().selectOne(getNameSpace() +"queryById", param);
    ...
    public <T> void updateFieldsById(T obj, String... fields) throws Exception {
    	...
    	List<KeyValuePair> keyValuePairs = CommonDaoUtil.listKeyValuePair(obj, obj.getClass(),false, fields);
	...
	public List<? extends AbstractEntity> fullTextList(Map<String, Object> param)
		...
		return (List<? extends AbstractEntity>)getSqlSession().selectList(getNameSpace() + "fullTextList", param);
		//TODO 没写XML
	}
